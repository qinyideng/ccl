...
def net_builder(net_name, from_name: bool, net_conf=None, is_remix=False):
    ...
    if from_name:
        ...
        elif net_name == 'WideResNetVar' or net_name == 'WideResNetVar_Proj':
            import models.nets.wrn_var as net
            builder = getattr(net, 'build_WideResNetVar')()
        elif net_name == 'WideResNet_Proj':
            import models.nets.wideresnet as net
            builder = getattr(net, 'build_WideResNet_Proj')()
