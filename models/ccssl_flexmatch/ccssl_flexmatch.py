...
from .ccssl_flexmatch_utils import consistency_loss, Get_Scalar
...
class CCSSL_FlexMatch:
    def __init__(self, net_builder, num_classes, ema_m, T, p_cutoff, hard_label=True, t_fn=None, p_fn=None, it=0, num_eval_iter=1024, tb_log=None, logger=None):
        ...
        super(CCSSL_FlexMatch, self).__init__()
    ...
    def train(self, args, logger=None):
        ...
        for (_, x_lb, y_lb), (x_ulb_idx, x_ulb_w, x_ulb_s, x_ulb_s1) in zip(self.loader_dict['train_lb'],
            ...
            with amp_cm():
                ...
                unsup_loss, mask, select, pseudo_lb, p_model, max_probs = consistency_loss(logits_u_s,
                                                                                logits_u_w,
                                                                                classwise_acc,
                                                                                p_target,
                                                                                p_model,
                ...
                total_loss = sup_loss + args.lambda_u * unsup_loss + args.lambda_con * con_loss
