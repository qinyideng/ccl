...
class WideResNet(nn.Module):
    def __init__(self,
        ...
        self.block1 = NetworkBlock(
            n, channels[0], channels[1], block, first_stride, dropRate, activate_before_residual=True)
        # 2nd block
        self.block2 = NetworkBlock(
            n, channels[1], channels[2], block, 2, dropRate)
        # 3rd block
        self.block3 = NetworkBlock(
            n, channels[2], channels[3], block, 2, dropRate)
...
class build_WideResNet_Proj:
    def __init__(self, first_stride=1,
                 depth=28,
                 widen_factor=2,
                 dropRate=0.0,
                 proj=True,
    ...
    def build(self, num_classes):
        return WideResNet(first_stride=self.first_stride,
                          depth=self.depth,
